...
## Data Cleaning
I select 10 columns from the original data set, then assign their format in order to fit the models. Because the scale of intterest rate is not appropriate, so I centralized them.
```{r}
